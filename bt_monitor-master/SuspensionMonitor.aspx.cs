...
namespace BizTalk_Monitor
{
    public partial class SuspensionMonitor : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (index == 2)
                {
                    if (ViewState["MsgChanged"].ToString() == "YES")
                    {
                        ...
                        string error;
                        DataTable contexts = BizTalk_Monitor_Helper.MonitorHelper.GetMessageConetxt(ConfigurationManager.AppSettings["serverNameKey"].ToString(), lblInstanceID.Text, lblMessageID.Text, out error);
        ...
        private void MainGridSelectedIndexChanged()
        {
            ...
            DataTable suspendtable = BizTalk_Monitor_Helper.MonitorHelper.ExecuteMsgBoxQuery(ConfigurationManager.AppSettings["serverNameKey"].ToString(), ViewState["MainGridSelectIndexChanged"].ToString());
        ...
        private void BindGrdViewInstanceDetail(string sortExp, string sortDir)
        {
            ...
            //BizTalk_Monitor_Helper.MonitorHelper.ExecuteMsgBoxQuery(ConfigurationManager.AppSettings["serverNameKey"].ToString(), ViewState["MainGridSelectIndexChanged"].ToString());
        ...
        private void BindGrdViewMain(string sortExp, string sortDir)
        {
            ...
            //BizTalk_Monitor_Helper.MonitorHelper.ExecuteMsgBoxQuery(ConfigurationManager.AppSettings["serverNameKey"].ToString(), ViewState["MainGridCommand"].ToString());
        ...
        {
            BizTalk_Monitor_Helper.MonitorHelper.ResumeInstance(servreName, instanceUniqueIDList);
        }

        private void TerminateInstance(string serverName, ArrayList instanceUniqueIDList)
        {
            BizTalk_Monitor_Helper.MonitorHelper.TerminateInstance(serverName, instanceUniqueIDList);
        }
