...

{
    public partial class CustomQuery : System.Web.UI.Page
    {
                ...
                if (ViewState["ApplicationDomain"] != null)
                {
                    ...
                    else
                    {
                        ...
                        if (!isConditionSelected(csvConditions))
                        {
                            ...
                            DataTable noConditiontable = BizTalk_Monitor_Helper.MonitorHelper.ExecuteMsgBoxQuery(ConfigurationManager.AppSettings["serverNameKey"].ToString(), strcommand);
        ...
        protected void grdViewGroup_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "ShowPopup")
                {
                    ...
                    {
                        List<KeyValuePair<string, string>> comboDataSource = BizTalk_Monitor_Helper.MonitorHelper.GetDropDownDataSource(viewInstanceDataTable);
        ...
        //        txtDetail.Text = BizTalk_Monitor_Helper.MonitorHelper.RichTextBoxFunctionality(message.OuterXml.ToString().Trim());
        //        ConfigFile = null;
        //        Popup(true, sender);
        ...
        //        XmlDocument message = GetMessageContent(messageDetails);
        //        txtODetail.Text = BizTalk_Monitor_Helper.MonitorHelper.RichTextBoxFunctionality(message.OuterXml.ToString().Trim());
        ...
        protected void btnSuspendConfirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (instanceList != null)
                {
                    ...
                    {
                        BizTalk_Monitor_Helper.MonitorHelper.ResumeInstance(ConfigurationManager.AppSettings["serverNameKey"].ToString(), instanceList);
                    }
                    else
                    {
                        BizTalk_Monitor_Helper.MonitorHelper.SuspendInstance(ConfigurationManager.AppSettings["serverNameKey"].ToString(), instanceList);
                    }
                }
        ...
        protected void btnConfirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (instanceList != null)
                {
                    BizTalk_Monitor_Helper.MonitorHelper.TerminateInstance(ConfigurationManager.AppSettings["serverNameKey"].ToString(), instanceList);
                }
                        ...
                        if (instanceMessageDataTable.Rows.Count > 0)
                        {
                            ...
                            if (msgID_Type.Count > 0)
                            {
                                ...
                                foreach (KeyValuePair<string, string> pair in msgID_Type)
                                {
                                    ...
                                    XmlDocument message = BizTalk_Monitor_Helper.MonitorHelper.GetMessageFromBtsMsgBox(messageInfo);
                                    if(isGrouped)
        ...
        private void BindGrdViewMain(string sortExp, string sortDir)
        {
            ...
            DataTable suspendtable = (DataTable)ViewState["MainGridDataTable"];
                //BizTalk_Monitor_Helper.MonitorHelper.ExecuteMsgBoxQuery(ConfigurationManager.AppSettings["serverNameKey"].ToString(), ViewState["MainGridQuery"].ToString());
        ...
        private void BindGrdViewInstanceDetail(string sortExp, string sortDir)
        {
            ...
            DataTable suspendtable = (DataTable)ViewState["AllGridDataTable"];
                //BizTalk_Monitor_Helper.MonitorHelper.ExecuteMsgBoxQuery(ConfigurationManager.AppSettings["serverNameKey"].ToString(), ViewState["AllGridQuery"].ToString());
        ...
        private void MainGridSelectedIndexChanged()
        {
            ...
            DataTable expandTable = BizTalk_Monitor_Helper.MonitorHelper.ExecuteMsgBoxQuery(ConfigurationManager.AppSettings["serverNameKey"].ToString(), strNewcommand);
        ...
        private void GetCustomQueryConditions()
        {
            ...
            try
            {
                ...
                customQueryDS = BizTalk_Monitor_Helper.MonitorHelper.ExecuteMgmtQueryDataSet(ConfigurationManager.AppSettings["serverNameKey"].ToString(), strcommand);
        ...
        private DataTable GetMainGridData(string serverName)
        {
            ...
            DataTable suspendtable = BizTalk_Monitor_Helper.MonitorHelper.ExecuteMsgBoxQuery(serverName, strcommand);
            ConfigFile = null;
            return suspendtable;
        }
        ...
        private DataTable GetInstanceData(string serverName, string instanceID, string host)
        {
            ...
            DataTable instanceTable = BizTalk_Monitor_Helper.MonitorHelper.ExecuteMsgBoxQuery(serverName, strcommand);
            ConfigFile = null;
        ...
        {
            XmlDocument message = BizTalk_Monitor_Helper.MonitorHelper.GetMessageFromBtsMsgBox(messageDetails);
        ...
        private string GetErrorDescription(string serverName, string instanceID)
        {
            ...
            DataTable errorDescription = BizTalk_Monitor_Helper.MonitorHelper.ExecuteMsgBoxQuery(serverName, strcommand);
        ...
        private void RefreshMainGrid()
        {
            ...
            DataTable refreshtable = BizTalk_Monitor_Helper.MonitorHelper.ExecuteMsgBoxQuery(ConfigurationManager.AppSettings["serverNameKey"].ToString(), strcommand);
