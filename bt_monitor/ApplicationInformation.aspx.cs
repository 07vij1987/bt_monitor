...
namespace bt_monitor
{
    public partial class ApplicationInformation : System.Web.UI.Page
    {
        ...
        private DataTable GetMainGridData(string serverName)
        {
            ...
            DataTable suspendtable = bt_helper.dbHelper.ExecuteMgmtQuery(serverName, strcommand);
            return suspendtable;
        }
        ...
        private DataSet GetArtifactData(string appName)
        {
            ...
            artifactInfo = bt_helper.dbHelper.ExecuteMgmtQueryDataSet(ConfigurationManager.AppSettings["serverNameKey"].ToString(), strNewcommand);
