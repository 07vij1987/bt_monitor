    ...
    public partial class HostInstances : System.Web.UI.Page
    {
        ...
        protected void btnStart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bt_helper.dbHelper.StartHostInstances(selectedHostInstances);
        ...
        protected void btnRestart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bt_helper.dbHelper.StopHostInstances(selectedHostInstances);
                bt_helper.dbHelper.StartHostInstances(selectedHostInstances);
        ...
        protected void btnEnable_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    bt_helper.dbHelper.EnableHostInstances(instanceName);
                }
        ...
        protected void btnDisable_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (string instanceName in selectedHostInstances)
                {
                    bt_helper.dbHelper.DisableHostInstances(instanceName);
                }
        ...
        {
            DataTable hostTable = bt_helper.dbHelper.HostInstancesWMI();
        ...
        private void BindGrdViewMain(string sortExp, string sortDir)
        {
            DataTable hostTable = (DataTable)ViewState["HostInstanceTable"];
                //bt_helper.dbHelper.HostInstancesWMI();
