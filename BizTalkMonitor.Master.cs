...
{
    public partial class BizTalkMonitor : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                userAuthorization = BizTalk_Monitor_Helper.MonitorHelper.UserAccessDetails(connection, storedProc, userName, useConfig);
